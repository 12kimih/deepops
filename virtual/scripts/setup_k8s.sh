...
kubectl get nodes
#kubectl run gpu-test --rm -t -i --restart=Never --image=nvcr.io/nvidia/cuda:12.4.1-base-ubuntu22.04 --overrides='{"spec":{"containers":[{"name":"gpu-test","resources":{"limits":{"nvidia.com/gpu":"1"}}}]}}' -- nvidia-smi
